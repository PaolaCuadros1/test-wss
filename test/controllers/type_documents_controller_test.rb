...
class TypeDocumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type_document" do
    assert_difference('TypeDocument.count') do
      post type_documents_url, params: { type_document: { name: @type_document.name, type: @type_document.type } }
    end
  ...
  test "should update type_document" do
    patch type_document_url(@type_document), params: { type_document: { name: @type_document.name, type: @type_document.type } }
